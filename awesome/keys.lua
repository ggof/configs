...
keys.globalkeys = gears.table.join(
    ...
    -- change layouts
    awful.key({modkey}, "t", function() awful.client.floating = not awful.client.floating end,
              {description = "set floating to false", group = "layout"}),
    ...
    awful.key({ modkey, ctrlkey }, "p", function() awful.spawn.with_shell("get_pass") end,
              {description = "rofi pass helper", group = "launcher"}),
